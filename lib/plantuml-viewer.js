...
module.exports.openViewerForEditor = function (editor) {
    ...
    if (!viewer) addViewerForUri(uri)
        ...
        viewer.activateItem(viewer.itemForURI(uri))
        //viewer.activate()           // Bring view for this editor to the front..
        prevActivePane.activate()   // ..and put focus back to the editor.
   }
}
